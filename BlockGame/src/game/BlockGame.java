...
public class BlockGame {
    ...
    static int barXTarget = bar.x; //targetX ==> interpolation
    static int dir = 0;
    ...
    static class Block{
        ...
        int color = 0; //0:white 1:yellow 2:blue 3:orange 4:red
        ...
        public void checkCollision(){
            if(dir == 0){ //up-right
                ...
                if(ball.getBottomCenter().y >= bar.y){
                    if(dupRect(new Rectangle(ball.x, ball.y, ball.width, ball.height),
